      ...
      <div className='services'>
          <div className='services__service'>
            ...
            <p className='services__serviceText'>
              ...
              <ul>
                <li>
                  We systematically search scholarly databases and grey
                  literature
                </li>
                <li>
                ...
                <li>
                  We manage references using EndNote and Mendeley programs
                </li>
                <li>
                ...
                <li>
                  Identifying relevant journals to publish research results
                </li>
              </ul>
            </p>
            <Link className='services__serviceLink' to='/services'>
              Read More
            </Link>
          </div>
          <div className='services__service'>
            ...
            <p className='services__serviceText'>
              ...
              <ul>
                ...
                <li>Research findings presentation</li>
              </ul>
            </p>
            <Link className='services__serviceLink' to='/services'>
              Read More
