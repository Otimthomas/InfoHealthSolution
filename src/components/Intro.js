    ...
    <div className='intro'>
      <div className='intro__left'>
        ...
        <p className='intro__text'>
          ...
          pariatur possimus voluptatum, quod ut quidem mollitia. Sapiente sequi
          aliquam vero accusamus numquam officia corporis repudiandae
          repellendus, rem sed? Maiores magnam minima modi facilis reprehenderit
          aut aliquid expedita recusandae perspiciatis iste.
        </p>
        <p className='intro__text'>
